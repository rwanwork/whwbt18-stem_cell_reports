...
"Usage:  pca.R --input INPUT --graphs GRAPHS [--log]
...
#####################################################################
##  Plot PCA on all samples
#####################################################################

pca_obj <- createPCA (genes_fpkm)
showPCAVariance (GRAPHS_ARG, pca_obj)
showPCAPlot (GRAPHS_ARG, genes_fpkm, pca_obj)
